...
> **현재 상태는 [2026-09-15 최신 진행 보고서](docs/2026-09-15-recording-repair-verification.md)를 참고한다.** DB 복구·후속 적용과 11개 목록 전체 게시 검증을 완료했다. 교정 history는 로컬 설치를 마쳤고 공개 배포 검증·실제 일간 재실행이 남아 있다. 아래 본문은 이전 시점의 관측과 판단을 보존한 기록이다. 당시의 NO-GO와 일본어판 제외 여부 답변 대기는 현재 결정·진행 상태가 아니다.
